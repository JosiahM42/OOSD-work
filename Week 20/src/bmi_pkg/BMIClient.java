...
public class BMIClient extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("BMIClient"); // Set the stage title
...
//            Socket connectToServer = new Socket("2.216.113.8", 8000);
            Socket connectToServer = new Socket("86.31.134.143", 8000);
